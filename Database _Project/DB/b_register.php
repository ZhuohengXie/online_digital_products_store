     ...
     <div class="clear"></div>
          ...
          <div class="register_account">
    	      ...
    	      <h4 class="title">Create an Account</h4>
    		   <form method="post" action="bregister.php" name="send" onSubmit="return Check()">
    			 <div class="col_1_of_2 span_1_of_2">
		   			 <div><input name="Username" type="text" value="Username" onFocus="this.value = '';" onBlur="if (this.value == '') {this.value = 'Username';}"></div>
