	...
	<div class="header-top">
     ...
     <div class="clear"></div>
          ...
          <div class="register_account">
			  ...
			  <li> Please choose your customer type:</li>
			  <br>
			  <div style="width:100px; margin:0 auto; text-align:left;">
			  <a href="h_register.php"><button type="button" class="grey" >Home Customer</button></a><br><br>	
			  </div>	
			  <br>
			  <br>	 
			  <div style="width:100px; margin:0 auto; text-align:left;"> 
			   <a href="b_register.php"><button type="button" class="grey"  > Bussiness Customer</button> </a>
			  </div>
			  <br>
			  <br>
			  <br>
